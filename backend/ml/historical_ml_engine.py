    ...
    def export_dataset(self, db: Session) -> bytes:
        ...
        if not orders:
            header = ",".join([
                ...
                "scratches_count", "yellowing_count", "sole_separation_count",
                "deep_stains_count", "rips_holes_count", "worn_out_count"
            ]) + "\n"
        ...
        for o in orders:
            ...
            rows.append({
                ...
                "expected_release_date": o.original_estimated_release_date.strftime("%Y-%m-%d") if getattr(o, "original_estimated_release_date", None) else "",
        ...
        if len(orders) < 5:
            return {
                ...
                "message": (
                    ...
                    f"Encode more historical orders with an Expected Release Date."
                ),
